...
describe('harmonic prediction', function () {
  ...
  test('it finds high and low tides', function () {
    ...
    var labelResults = (0, _index["default"])(_constituents["default"], 'phase_GMT', false).setTimeSpan(startDate, extremesEndDate).prediction().getExtremesPrediction(customLabels);
