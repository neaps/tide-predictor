...
/*#__PURE__*/
function () {
  function TidePrediction(harmonicConstituents) {
    _classCallCheck(this, TidePrediction);
  ...
  _createClass(TidePrediction, [{
    ...
    value: function getWaterLevelAtTime(time) {
      var harmonic = new _index["default"](this.harmonicConstituents);
