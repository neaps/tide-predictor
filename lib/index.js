...
var tidePredictionFactory = function tidePredictionFactory(constituents, options) {
  ...
  var tidePrediction = {
    ...
    getExtremesPrediction: function getExtremesPrediction(start, end, highLowLabels) {
      return (0, _index["default"])(constituents, phaseKey, offset).setTimeSpan(start, end).prediction().getExtremesPrediction(highLowLabels);
    },
